...
public class SafeUserFormatter implements Formatter<SafeUser> {
	...
	public SafeUser parse(String text, Locale locale) throws ParseException {
		return ((UserRepository) BeanUtils.getBean(UserRepository.class)).findById(Integer.parseInt(text), SafeUser.class);
	}
