											...
											<c:choose>
												...
												<c:when test="${fieldTypeName eq 'USERNAME' }">
													<div class="form-group">
														<form:input path="${formName}" class="form-control" maxlength="${formInfo.maxlength}" placeholder="${formInfo.placeholder}" required="true" />
														<form:errors path="${formName}" class="error" />
													</div>
												</c:when>
												...
												<c:when test="${fieldTypeName eq 'PASSWORD' }">
													<div class="form-group mb-2">
														<form:password path="${formName}" class="form-control" maxlength="${formInfo.maxlength}" placeholder="${formInfo.placeholder}" required="true" />
														<form:errors path="${formName}" class="error" />
													</div>
												</c:when>
												...
												<c:when test="${fieldTypeName eq 'FILE_UPLOAD_FORM' or fieldTypeName eq 'IMAGE_UPLOAD_FORM'}">
													...
													<div class="input-group">
														<div class="custom-file">
													      <input type="file" name="${formName}" id="${formName}" class="custom-file-input" accept="${formInfo.accept}" onChange="customFileInputOnChange(this)" ${requiredHtml} >
													      <label class="custom-file-label">${formInfo.labelText}</label>
													    </div>
													    <div class="input-group-append">
															      <span class="input-group-text" onclick="setFileToNull('${formName}', '${formInfo.labelText}');"><i class="fas fa-times"></i></span>
														</div>
														<form:errors path="${formName}" class="error" />
													</div>
												</c:when>
												...
												<c:when test="${fieldTypeName eq 'INTEGER' }">
													<div class="form-group">
														<form:input path="${formName}" class="form-control" onKeydown="setInputFilter(this, integerFilter, ${formInfo.min}, ${formInfo.max})" maxlength="${formInfo.maxlength}" placeholder="${formInfo.placeholder}" required="${required}" />
														<form:errors path="${formName}" class="error" />
													</div>
												</c:when>
												...
												<c:when test="${fieldTypeName eq 'FLOAT' }">
													<div class="form-group">
														<form:input path="${formName}" class="form-control" onKeydown="setInputFilter(this, floatFilter, ${formInfo.min}, ${formInfo.max})" maxlength="${formInfo.maxlength}" placeholder="${formInfo.placeholder}" required="${required}" />
														<form:errors path="${formName}" class="error" />
													</div>
												</c:when>
												...
												<c:when test="${fieldTypeName eq 'JOIN_ONE_TEXT' }">
													...
													<div class="form-group">
														<form:input path="${formName}" class="form-control" value="${joinOneValue}" maxlength="${formInfo.maxlength}" placeholder="${formInfo.placeholder}" required="${required}" />
														<form:errors path="${formName}" class="error" />
													</div>
												</c:when>
