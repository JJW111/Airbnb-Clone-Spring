...
<div class='flex flex-col w-full'>
	<a href="/login/github" class="btn w-full border-2 text-gray-700 mb-2 border-gray-700">
		<i class="fab fa-github-alt mr-2 fa-lg"></i> Continue with Github
	</a>
	<a href="/login/kakao" class="btn w-full border text-yellow-800 mb-2 border-yellow-500 bg-yellow-400">
