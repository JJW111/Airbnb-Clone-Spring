...
<div class="container mx-auto my-10 flex flex-col">
    ...
    <div class="flex flex-col items-start border-l border-r border-t border-b">
        ...
        <div class="flex p-5 border-b w-full">
            ...
            <c:if test="${principal.username ne reservation.guest.username}">
	    ...
	    <div class="py-10 px-5">
        	...
        	<c:if test="${principal.username eq reservation.guest.username}">
		        <c:if test="${reservation.status == 'CONFIRMED' and reservation.isFinished()}">
		        	<a href="/reviews/write/${reservation.id}" class="text-xl font-medium text-blue-600">Write a Review</a>
				</c:if>
			</c:if>
	    </div>
